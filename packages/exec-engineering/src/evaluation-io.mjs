...
import { assignmentDirectory, assertEvaluationDiffPaths, changedPathsFromUnifiedDiff, evaluationDirectory } from "@connorbritain/roadmap-core/evaluation-core.mjs";
import { PACKET_MAX_BYTES, safePacketPath, validateEvaluationPacket, prohibitedDataFindings, packetDigest } from "@connorbritain/roadmap-core/evaluation-packet.mjs";
